...
export const FILE_ICONS = {
  ...
  'claude-security': `<svg class="file-icon brand-claude" viewBox="0 0 16 16" width="14" height="14" aria-hidden="true">${STICKER_BASE}<path class="fg" d="${CLAUDE_MARK_PATH}"/></svg>`,
