...
// their top level. Done before any user-driven
// `import('./terminal.js')` / `import('./graph.js')` so the slot is
// populated by the time a lazy bundle's wrapper module reads it.
