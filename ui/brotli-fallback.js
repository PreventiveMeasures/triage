...
// `DecompressionStream('br')`. Built as a separate bundler entry
...
// runtime string + `@vite-ignore`, so the bundler leaves it alone
// and the browser resolves it against the page's URL.
