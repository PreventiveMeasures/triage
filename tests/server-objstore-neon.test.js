...
// backend (`server-e2e/objstore/store-neon.ts`) instead of SQLite, with an
...
import { MAX_RESOURCES_PER_WORKSPACE, abortPut, beginPut, commitPut, deleteObject, getLive, listLive } from '../server-e2e/objstore/store.ts'
