...
let fetchResult, saveResult, writes
...
const { loadManagedReportComments, managedCommentsFor, writeManagedComment } = await import('../ui/view/managed-comments.js')
...
test('managed comment hydration stays in its report scope and accepts unattributed notes', async () => {
  const legacy = { ...comment, id: 'legacy', authorId: null, authorLogin: null }
